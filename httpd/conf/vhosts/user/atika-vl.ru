<VirtualHost 127.0.0.1:8080>
	ServerName atika-vl.ru
	DocumentRoot /var/www/user/data/www/fortros_site
	ServerAdmin support@fortros.ru
	AddDefaultCharset off
	AssignUserID user user
	CustomLog /var/www/httpd-logs/atika-vl.ru.access.log combined
	ErrorLog /var/www/httpd-logs/atika-vl.ru.error.log
	...
	Redirect 301 /http:/atika-dv.ru/index.php http://atika-vl.ru/index.php
	ServerAlias www.atika-vl.ru
